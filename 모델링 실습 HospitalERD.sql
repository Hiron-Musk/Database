...
insert into departments values('105','이비인과','강감찬','051-123-0105');
...
insert into nurses values('N103101','103','정준하','1933-10-12','M','주임','010-2104-6610','jung@bw.com');
...
insert into charts values('C1031002',1031002,'D102101','P103101','입원 치료');
insert into charts values('C1021003',1021003,'D102101','P102104','위내시경');
insert into charts values('C1041004',1041004,'D102101','P104101','피부 감염 방지 주사');
insert into charts values('C1051005',1051005,'D102101','P105101','비염 치료');
insert into charts values('C1031006',1031006,'D102101','P103101','목 견인 치료');
insert into charts values('C1041007',1041007,'D102101','P104101','여드름 치료약 처방');
insert into charts values('C1081008',1081008,'D102101','P108101','발목 깁스');
insert into charts values('C1021009',1021009,'D102101','P102104','주사 처방');
insert into charts values('C1071010',1071010,'D102101','P107104','MRI 검사');
insert into charts values('C1051011',1051011,'D102101','P105102','귀 청소 및 약 처방');
insert into charts values('C1041012',1041012,'D102101','P104103','화상 크림약 처방');


#문제1
select doc_id,doc_name,doc_birth,b.dep_no,dep_name from doctors as a
...
#문제4
select pat_name,doc_name,treat_contents,chart_contents,treat_datetime from charts as a
...
#문제5 
select d.treat_no, pat_name,doc_name,treat_contents, chart_contents,treat_datetime 
...
#문제6
select d.treat_no,pat_name,doc_name,treat_contents,chart_contents,treat_datetime from charts as a
join patients as b on a.pat_id=b.pat_id
join doctors as c on a.doc_id=c.doc_id
join treatments as d on a.treat_no=d.treat_no
...
select * from patients where year(now())-concat(19,substring(pat_jumin,1,2))
between 30 and 40;
...
#문제10
select a.nur_id,nur_name,count(*) as 담당환자수 from nurses as a
join patients as b on a.nur_id=b.nur_id 
group by a.nur_id
